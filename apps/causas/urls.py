...
urlpatterns = patterns('sij.apps.causas.views',
	...
	url(r'^nuevacausa/(?P<jurisdiccion>[-\w]+)/(?P<tribunal>[-\w]+)/$','asignar_receptor_view', name='vista_asignar_receptor'),
	...
	url(r'^causa/aceptar/$', 'aceptar_causa_view', name='aceptar_causa'),
	...
	url(r'^causa/(?P<idcausa>[-\w]+)/editar/$', 'editar_causa_view', name='editar_causa'),
	url(r'^causa/(?P<idcausa>[-\w]+)/editar/opciones/$', 'opciones_editar_causa_view', name='opciones_editar_causa'),
	url(r'^causa/(?P<idcausa>[-\w]+)/editar/registrar/$', 'registrar_editar_causa_view', name='registrar_editar_causa'),
